<?php 
    ...
    $totalHarga =0;
    $idTranksaksi = $idsession. date('YmdHm');
    ...
    for($i=0;$i < count($resultKeranjang);$i++){
        ...
        $resultInsertDetailtranksaksi = mysqli_query($conn,"INSERT INTO detail_transaksi (ID_tranksaksi,ID_Barang,jumlah_barang,harga) VALUES ('$idTranksaksi',$idBarang,$jumlahBarangKeranjang,$resultHargaBarang)");
    ...
    header("location:user-transaction-detail.php");
?>